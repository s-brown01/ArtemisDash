...
//        levelManager.update(); 
     ...
     * @param right  - true if the arrow is moving right, false is left
     * 
     */
    public void addPlayerArrow(float x, float y, float slope, boolean right) {
        projManager.newArrow(x, y, slope, right);
    }
