...
public class LevelManager {
    ...
    private void loadLevels() {
       levels[0] = new Level(LoadSave.getLevelData(LoadSave.LEVEL1_DATA));
       levels[1] = new Level(LoadSave.getLevelData(LoadSave.LEVEL2_DATA));
       for (int i =2; i <levels.length; i ++) {
           levels[i] = new Level(LoadSave.getLevelData(LoadSave.LEVEL2_DATA));
       }
//       levels[3] = new Level(LoadSave.getLevelData(LoadSave.LEVEL3_DATA));
