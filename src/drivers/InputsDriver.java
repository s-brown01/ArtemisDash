...
public class InputsDriver implements DriverInterface {
    ...
    private boolean testMouse() {
        ...
        MouseEvent pressLeft = new MouseEvent(null, MouseEvent.MOUSE_PRESSED, System.currentTimeMillis(), 0, (int)(testPlayer.getHitbox().x - 40), (int)(testPlayer.getHitbox().y - 40), 1, false);
        ...
        MouseEvent dragRight = new MouseEvent(null, MouseEvent.MOUSE_DRAGGED, System.currentTimeMillis(), 0, (int)(testPlayer.getHitbox().x + 40), (int)(testPlayer.getHitbox().y + 40), 1, false);
        ...
        MouseEvent release = new MouseEvent(null, MouseEvent.MOUSE_RELEASED, System.currentTimeMillis(), 0, (int)(testPlayer.getHitbox().x + 50), (int)(testPlayer.getHitbox().y - 100), 1, false);
    ...
    private boolean testKeyboard() {
        ...
        KeyEvent tRelease = new KeyEvent(null, KeyEvent.KEY_RELEASED, System.currentTimeMillis(), 0, KeyEvent.VK_T, '\0');
        ...
        KeyEvent aRelease = new KeyEvent(null, KeyEvent.KEY_RELEASED, System.currentTimeMillis(), 0, KeyEvent.VK_A, '\0');
        KeyEvent dRelease = new KeyEvent(null, KeyEvent.KEY_RELEASED, System.currentTimeMillis(), 0, KeyEvent.VK_D, '\0');
