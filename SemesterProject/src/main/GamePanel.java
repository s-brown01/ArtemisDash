...
public class GamePanel extends JPanel {
	 ...
	 * toolkit.getImage("icons/handwriting.gif"); Cursor c =
	 * toolkit.createCustomCursor(image , new Point(mainPane.getX(),
	 * mainPane.getY()), "img"); mainPane.setCursor (c); how to restore to default
	 * cursor (good for the menu?): setCursor(Cursor.getDefaultCursor());
	 */
