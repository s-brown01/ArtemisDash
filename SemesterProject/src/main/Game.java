...
public class Game implements Runnable {
    ...
    /**
     * Begins the main loop on a separate thread Done to dedicate a specific thread
     * to free up logical traffic
     */
...
//TESTING:             levelManager.draw(g);
    ...
    /**
     * Handles the update aspects of the game, such as updates to logical processes
