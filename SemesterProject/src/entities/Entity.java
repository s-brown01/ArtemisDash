...
public abstract class Entity {
    /**
     * Parameters that every instance of entity will inherit Multiplying these by
     * SCALE means it will remain proportionally the same on screen Protected
     * variables mean that only instances of this class can use
     */
