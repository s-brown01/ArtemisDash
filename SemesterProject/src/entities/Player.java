...
public class Player extends Entity {
    ...
    /**
     * Loads ALL animations from a sprite sheet into a 2D array The length of this
     * array, will be the length of the longest animation
     */
    ...
    /**
     * Updates position of hitbox as well as player sprite Handles things such as
     * pressing Left and Right simultaneously
     */
    ...
    /**
     * Keeps track of the player movement by setting a True or False value Will be
     * used for "Coyote Time", shooting, among other Player related movement options
     * 
     * @param moving
     */
    ...
    /**
     * Resets animation timers and indexes to repeat animation once end of sprite
